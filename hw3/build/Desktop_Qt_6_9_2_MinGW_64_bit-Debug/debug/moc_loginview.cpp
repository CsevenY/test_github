...
void LoginView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginView::*)()>(_a, &LoginView::loginSuccess, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginView::*)()>(_a, &LoginView::loginFailed, 1))
            return;
    }
}
